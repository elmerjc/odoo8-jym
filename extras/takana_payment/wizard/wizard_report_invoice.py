...
class report_invoice_wizard(osv.osv_memory):
    _name = 'wizard.report.invoice'
    _description = 'Reporte de facturas por proveedor'
    _columns = {
    ...
    def print_report(self,cr,uid,ids,context=None):
        ...
        return self.pool['report'].get_action(cr,uid,[],'takana_payment.report_invoice',data=data,context=context)
    ...
    def view_report(self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'name': _('Analisis de facturas'),
            'view_type': 'form',
            'view_mode': 'graph',
            'res_model': 'takana.invoice',
